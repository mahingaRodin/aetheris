        ...
        <div className="grid gap-12 md:grid-cols-[1.5fr_1fr_1fr]">
          ...
          <div>
            ...
            <a
              ...
              className="mb-6 inline-flex items-center gap-2 font-mono text-sm text-muted transition-colors hover:text-primary"
            >
            ...
            <div className="flex gap-4">
              {siteConfig.socials.map((social) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-border text-muted transition-all hover:border-primary hover:text-primary"
                >
                  {iconMap[social.label] ?? social.label[0]}
                </a>
              ))}
            </div>
          </div>
