        ...
        <div className="grid gap-6 md:grid-cols-3">
          {rest.map((project, index) => (
            <motion.article
              ...
              className="group overflow-hidden rounded-2xl border border-border bg-card transition-all duration-400 hover:-translate-y-1 hover:border-primary hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)]"
            >
